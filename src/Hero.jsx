...
import backgroundImage from '../src/assets/philipp-katzenberger-iIJrUoeRoCQ-unsplash.jpg'
...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      >
        {/* Gradient overlay with custom blur value (8px) */}
        ...
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-white/90 mb-10 leading-relaxed">
              ...
              <span className="font-medium text-white"> custom web, mobile, and cloud applications</span> that
